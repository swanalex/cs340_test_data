...
VALUES
    (3, 11, 'Delta Airlines', 180, 250, '2023-05-10', '09:00 AM', '12:00 PM'),      -- ID 1
    (6, 19, 'United Airlines', 120, 200, '2023-06-01', '06:30 PM', '08:30 PM'),     -- ID 2
    (13, 8, 'American Airlines', 240, 300, '2023-05-25', '10:00 AM', '02:00 PM'),   -- ID 3
    (5, 2, 'Southwest Airlines', 90, 150, '2023-05-08', '03:30 PM', '05:00 PM'),    -- ID 4
    (16, 4, 'Delta Airlines', 150, 200, '2023-06-14', '07:30 AM', '10:00 AM'),      -- ID 5
    (10, 18, 'United Airlines', 120, 150, '2023-05-17', '12:00 PM', '02:00 PM'),    -- ID 6 
    (14, 9, 'American Airlines', 180, 250, '2023-05-12', '08:00 AM', '11:00 AM'),   -- ID 7
...
VALUES
    (5, 8, 350.00, '12A'),      -- ID 1
    (10, 1, 250.00, '23C'),     -- ID 2
    (15, 3, 420.50, '10B'),     -- ID 3
    (2, 9, 280.00, '15D'),      -- ID 4
    (8, 5, 320.75, '18F'),      -- ID 5
    (11, 2, 450.00, '07A'),     -- ID 6
    (17, 4, 275.50, '14C'),     -- ID 7
    (1, 10, 360.00, '22B'),     -- ID 8
    (6, 7, 295.25, '19E'),      -- ID 9
    (19, 6, 500.00, '06A');     -- ID 10
